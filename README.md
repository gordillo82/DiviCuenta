...
> **Si ya tenías el schema anterior aplicado**, el archivo incluye al final un bloque de migración que puedes ejecutar de forma independiente. Busca la sección `MIGRACIÓN: Bebidas compartidas` y ejecuta solo esas líneas en el SQL Editor. Los cambios son:
> - `ALTER TABLE drinks ALTER COLUMN diner_id DROP NOT NULL` (hace el campo opcional)
> - Creación de la tabla `drink_participants` con sus índices y política RLS
...
| **Total por persona** | `bebidas propias + parte de bebidas compartidas + parte de comida` |
